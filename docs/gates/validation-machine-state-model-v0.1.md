...
### Epistemic / governance terminal states
...
- `NOT_AUTHORIZED` — the requested transition or action is outside the machine's authorization boundary.
...
A transition not explicitly authorized by this model or by a later approved refinement is forbidden.
